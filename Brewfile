...
brew "php"
# Execute automation tasks and decrypt Ansible Vault secrets
brew "ansible"
...
# 1Password is optional: useful for retrieving the Ansible Vault password or SSH bootstrap keys
cask "1password-cli"
cask "1password"
...
cask "ghostty"
# Local speech-to-text / dictation utility
cask "kitlangton-hex"
